...
### Equipment
![The paperdoll showing an equipped robe's tooltip](../assets/images/basics-paperdoll-equipped-robes.png)
...
![The backpack showing a knife's tooltip](../assets/images/basics-backpack-knifes-tooltip.png)
...
### Maximum Capacity
![A small picture of the weight icon from the status gump](../assets/images/basics-weight-icon-status.png)
...
### Stackable items
![A pile of 110 gold](../assets/images/basics-pile-110-gold.png) 
![A bar indicating you can select a subset of 110 gold](../assets/images/basics-bar-you-can.png)
...
## Paperdoll
![The paperdoll gump](../assets/images/basics-paperdoll-gump-figure.png)
...
![The character information gump](../assets/images/basics-character-information-gump.png)

### Skills Button
![The skills gump](../assets/images/basics-skills-gump-figure.png)
...
![The player's healthbar](../assets/images/basics-healthbar-figure-figure.png)
...
![The player's Status gump](../assets/images/basics-status-gump-figure.png)
...
![A snip of the player's statistics from the Status gump](../assets/images/basics-statistics-status-gump.png)
...
![The tooltip for the nightsight potion](../assets/images/basics-tooltip-nightsight-potion.png)
![The tooltip for the greater strength potion](../assets/images/basics-tooltip-greater-strength.png)
