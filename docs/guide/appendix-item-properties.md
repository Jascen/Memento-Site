...
**Faster Casting** - Decreases the time required to cast spells by 0.25 seconds per point. Different skills have different maximum FC caps.
...
**Hit Mana Drain** - Reduces the target's mana by a percentage of the damage dealt when the effect is triggered.
...
**Lower Ammo Cost** - Reduces the number of arrows/bolts used by a percentage.

**Lower Mana Cost** - Lowers the amount of mana needed to cast a spell or use a special move.

**Lower Reagent Cost** - Lowers the amount of reagents needed to cast spells like magery and necromancy. 100% negates the need to carry reagents at all. Tithing points, though unused, are required to be available to cast Chivalry/Knightship spells. Elementalism reduces the amount of stamina loss for casting spells.
...
**Mage Weapon** - Allows magery skill to substitute for the normal combat skill of the weapon. Special moves cannot be used via this substitution. Magery skill is reduced by the value noted while a mage weapon is equipped.
...
**Resist** - Types are: physical, fire, cold, poison, energy. This allows you to resist a percentage of all described damage.

**Self Repair** - Has a chance of regaining durability each time it takes damage in the amount of the self repair.

**Skill Bonus** - Increases points in that particular skill.

**Slayer** - Weapons and spellbooks will do increased damage against all creatures within a certain group (~ x2), while musical instruments will be more effective.

**Spell Channeling** – Retains equipped weapon or shield when casting spells.

**Spell Damage Increase** - Increases spell damage inflicted.

**Stamina Increase** - Increases your maximum stamina by the number of points on the item.

**Stamina Regeneration** - Increases the stamina regain rate.

**Strength Bonus** - Increases your Strength by this value.

**Swing Speed Increase** - Increases the base speed at which you swing your weapon. Duration between swing speed decreases until it reaches a minimum.

**Use Best Weapon Skill** - Substitutes the character's trained weapon skill for that normally required for the weapon type, but for melee weapons only. Marksmanship is not included.
